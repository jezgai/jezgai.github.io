...
"Al ser un viajero, reúnes un montón de conocimientos interesantes que te ayudan a sobrevivir durante las largas caminatas. Tus habilidades de combate son famosas, demostrando que eres un combatiente ducho sin miedo a los duelos.",
			...
			},
			{
			  ...
			  competencias: [ "Puedes llevar cualquier arma, cualquier escudo y armaduras hasta la cota de mallas." ],
			  ventajas: [ "<strong>Tiradas de Inteligencia</strong> para detectar puertas secretas.", "<strong>Tiradas de Carisma</strong> para evitar el encantamiento." ],
			  habilidades: [ "<strong>Arma sortílega</strong><br/>Tienes un arma de filo que alberga tu magia. Grabas en ella tus conjuros. Te da +1 a tiradas de daño mientras tengas algún cojuro memorizado. Si pierdes el arma pierdes 1 espacio de conjuro del nivel más alto para regenerarla.", "<strong>Lanzamiento de conjuros</strong><br/>Puedes lanzar conjuros aprendidos de la lista del Mago. En El Naufragio puedes encontrar el número de conjuros que puedes memorizar cada día. En lugar de conservarlos en un tomo de conjuros, los grabas en el filo de tu espada y los trasladas a tatuajes arcanos en tu cuerpo cuando los memorizas. Si no tienes tu arma sortílega, no podrás memorizar ni aprender conjuros.", "<strong>Magia apresurada</strong><br/>Además, cuando realizas un ataque puedes gastar un punto de energía para lanzar al mismo tiempo un conjuro cuyo tiempo de lanzamiento sea de un asalto." ],
			  lhabilidades: [ "Arma sortílega, Lanzamiento de conjuros, Magia apresurada" ],
			  cordura: "INT",
			  origen: "<a href='https://naufragio.net/clases-esgrimago' target='_blank'>El Naufragio</a>",
			  descripcion: "Eres uno de los pocos esgrimagos del mundo, maestro del arte de la magia y la espada, y quizás ya temas que seas de los últimos. Sin embargo, tus capacidades no difieren de las de tus ancestros: eres capaz de combatir cuerpo a cuerpo y lanzar conjuros al mismo tiempo, una proeza que ni el mayor de los héroes podría ser capaz.",
			  ...
			  equipo: { narmasAD: 1, armasAD: [ "Arco largo", "Arco corto" ], 
						narmasCaC: 2, armasCaC: [ "Espada larga", "Espada corta", "Espada ropera", "Daga" ], 
						escudo: [ "Escudo pequeño", "Escudo mediano", "Escudo grande" ],
