...
class YS_talentos {
	static talento() {
		var talentos = YS_Comun.shuffle([
						 { "nombre": "¡Es mi familia!", "descripcion": "Puedes ceder tus propias proezas a cualquier miembro de tu familia." },
						 { "nombre": "Afortunado", "descripcion": "Una vez por sesión, recuperas una proeza gastada." },
						 ...
						 { "nombre": "Damisela en apuros", "descripcion": "Tienes facilidad para despertar ese estúpido «instinto protector", "descripcion": " de los hombres. Siempre que vayas a recibir un ataque, puedes gastar una proeza para hacer dudar a un adversario masculino y hacerle malgastar su turno." },
						 ...
						 { "nombre": "Solo tengo que conectar este cable con este otro y entonces...", "descripcion": "Cuando quieres repetir uno o más dados de cualquier tirada de habilidad que tenga que ver con la informática, los dispositivos electrónicos o los sistemas de seguridad, lo haces sin pagar ninguna proeza por ello (solo una vez por tirada)." },
						 ...
						 { "nombre": "Competitivo", "descripcion": "Sumas 1D extra a cualquier tirada de habilidad si la acción que tratas de llevar a cabo se realiza en competencia expresa y declarada con otro u otros personajes." },
						 { "nombre": "Discurso memorable", "descripcion": "Una vez por sesión, puedes motivar a tus compañeros con un discurso acompañado de una tirada de Conversación contra su Aplomo. Si superas la tirada contra al menos uno de ellos, tú y todos los que hayáis sido «motivados", "descripcion": " ganaréis una proeza." },
