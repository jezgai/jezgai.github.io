class DungeonHack {
	...
	static cargapersonaje(pjs) {
		...
		for (indiceatr=0; indiceatr< personaje[numpj-1].atributos.length; indiceatr++) {
			seccion += "<tr><td><span class='mano' onclick='DungeonHack.tiradaatr(" + indiceatr + "," + (numpj-1) + ",1)'>" + personaje[numpj-1].atributos[indiceatr].nbatr + "</span></td><td>" + personaje[numpj-1].atributos[indiceatr].valor + " (" + personaje[numpj-1].atributos[indiceatr].valorASC + ")</td></tr>";
		}
		seccion += "</table></div>";
		pjsaux+= seccion;
		//document.getElementById("seccion1").innerHTML = seccion;
		
		if( personaje[numpj-1].hasOwnProperty('saludinicial') == false ){
			personaje[numpj-1].saludinicial = personaje[numpj-1].salud;
		}
		
		if( personaje[numpj-1].hasOwnProperty('energiainicial') == false ){
			personaje[numpj-1].energiainicial = personaje[numpj-1].energia;
		}
		
		if( personaje[numpj-1].hasOwnProperty('cordurainicial') == false ){
			personaje[numpj-1].cordurainicial = personaje[numpj-1].cordura;
		}
		...
		seccion += "<tr><td>Salud</td><td class='mano' onclick='DungeonHack.cambiacaracteristica(" + '"salud",' + (numpj-1) + ',"PJ")' + "' >" + personaje[numpj-1].salud + " (" + personaje[numpj-1].saludinicial + ")" + "</td></tr>";
		seccion += "<tr><td>Energia</td><td class='mano' onclick='DungeonHack.cambiacaracteristica(" + '"energia",' + (numpj-1) + ',"PJ")' + "' >" + personaje[numpj-1].energia + " (" + personaje[numpj-1].energiainicial + ")" + "</td></tr>";
		seccion += "<tr><td>Cordura</td><td class='mano' onclick='DungeonHack.cambiacaracteristica(" + '"cordura",' + (numpj-1) + ',"PJ")' + "' >" + personaje[numpj-1].cordura + " (" + personaje[numpj-1].cordurainicial + ")" + "</td></tr>";
		seccion += "<tr><td>PX</td><td class='mano' onclick='DungeonHack.cambiacaracteristica(" + '"px",' + (numpj-1) + ',"PJ")' + "' >" + personaje[numpj-1].px + "</td></tr>";
		...
		for (indice=0; indice<personaje[numpj-1].armas.length; indice++) {
			...
			if ( personaje[numpj-1].armas[indice].tipo == "CaC" ) {
				...
				funcion = "DungeonHack.tiradaarmaCaC";
				if ( personaje[numpj-1].armas[indice].danoAD.dado != 0 ) {
					...
					daño += ")";
					usoalternativo = " <span class='mano' onclick='DungeonHack.tiradaarmaAD("+ indice + "," + (numpj-1) + ",1)'>(A distancia)</span>";
				}
			}
			else {
				daño = personaje[numpj-1].armas[indice].danoAD.ndados + "d" + personaje[numpj-1].armas[indice].danoAD.dado;
				...
				funcion = "DungeonHack.tiradaarmaAD";
				if ( personaje[numpj-1].armas[indice].danoCaC.dado != 0 ) {
					...
					daño += ")";
					usoalternativo = " <span class='mano' onclick='DungeonHack.tiradaarmaCaC("+ indice + "," + (numpj-1) + ",1)'>(Cuerpo a cuerpo)</span>";
				}
			}
		...
		seccion = "<div onclick=" + '"' + "RolSolo.acordeon('pjventajas" + (numpj-1) + "')" + '"' + "class='w3-container w3-blue w3-center'><p><strong>Ventajas</strong></p></div>";
		seccion += "<div id='pjventajas" + (numpj-1) + "' class='w3-hide w3-container' >"
		seccion += "<table class='w3-table  w3-striped w3-border'>";
		for (indice=0; indice<personaje[numpj-1].ventajas.length; indice++) {
			seccion += "<tr><td>" + personaje[numpj-1].ventajas[indice] + "</td></tr>";
		}
		seccion += "</table></div>";
		pjsaux+= seccion;
		...
		for (indice=0; indice<personaje[numpj-1].habilidades.length; indice++) {
			seccion += "<tr><td>" + personaje[numpj-1].habilidades[indice] + "</td></tr>";
		}
		seccion += "</table></div>";
		pjsaux+= seccion;
