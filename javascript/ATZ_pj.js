class ATZ_PJ {
	...
	pintaRasgos() {
		...
		rasgos += "</table>";
		rasgos += "<h2>Talentos</h2>";
		rasgos += "<strong>" + talentos._talentos[this._talento].nombre + "</strong><br/>" + talentos._talentos[this._talento].descripcion;
		return rasgos;
	}
	...
	calculaTalento() {
		this._talento = Comun.random(talentos._talentos.length,0);
	}
