	...
	constructor() {
		...
		[
			...
			},
			{
			  ...
			  ventajas: [ "<strong>Tiradas de Destreza</strong> para moverte en silecio o esconderte en las sombras.", "<strong>Tiradas de Forrajeo</strong> en las Tierras Salvajes.", "<strong>Tiradas de Orientación</strong> en las Tierras Salvajes." ],
