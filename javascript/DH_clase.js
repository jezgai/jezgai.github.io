	...
	constructor() {
		...
		[
			...
			},
			{
			  ...
			  salud : 6,
			  atributo: [ "DES", "SAB" ],
			  competencias: [ "Puedes llevar cualquier arma ligera, de proyectiles, cuerpo a cuerpo de una mano y armaduras acolchadas, de cuero y de cuero tachonado." ],
			  ventajas: [ "<strong>Tiradas de Destreza</strong> para moverte en silencio o esconderte en las sombras.", "<strong>Tiradas de Forrajeo</strong> en las Tierras Salvajes.", "<strong>Tiradas de Orientación</strong> en las Tierras Salvajes." ],
...
"El ansia por explorar territorios y conocer a nuevas gentes más allá de tu bandada, que se te ha quedado pequeña.<br/>" +
"Los kenku tenéis un especial sentimiento de arraigo con vuestra comunidad, pero no es extraño ver alguno de los tuyos en los caminos mercadeando, seguramente, con información.",
			  nombresF: [ "Anka", "Kathia", "Morrigan", "Plumas", "Tethys", "Turmalina", "Urraca", "Vanta" ],
			  nombresM: [ "Corax", "Grip", "Kansuke", "Lutozo", "Mugin", "Reafan", "Soltan", "Tizón" ],
			  motesF: [ ],
			  motesM: [ ],
			  magia: { numero:-1, conjuros: [] },
